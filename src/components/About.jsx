...
const About = () => {
  ...
  return (
    <section
      id="about"
      className="min-h-screen flex items-center justify-center px-6 py-12 md:px-16 lg:px-32 bg-gray-900 text-white"
    >
      <div className="flex flex-col md:flex-row items-center md:items-start gap-10">
        ...
        <div className="flex-1">
          ...
          <p className="text-gray-300 leading-relaxed">{resumeData.aboutme}</p>
